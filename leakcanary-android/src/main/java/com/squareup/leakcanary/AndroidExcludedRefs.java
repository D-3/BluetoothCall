...
public enum AndroidExcludedRefs {
  ...
  INPUT_METHOD_MANAGER__SERVED_VIEW(SDK_INT >= ICE_CREAM_SANDWICH_MR1 && SDK_INT <= 23) {
    @Override void add(ExcludedRefs.Builder excluded) {
  ...
  INPUT_METHOD_MANAGER__ROOT_VIEW(SDK_INT >= ICE_CREAM_SANDWICH_MR1 && SDK_INT <= 23) {
    @Override void add(ExcludedRefs.Builder excluded) {
  ...
  USER_MANAGER__SINSTANCE(SDK_INT >= JELLY_BEAN && SDK_INT <= 23) {
    @Override void add(ExcludedRefs.Builder excluded) {
  ...
  CONNECTIVITY_MANAGER__SINSTANCE(SDK_INT <= 23) {
    @Override void add(ExcludedRefs.Builder excluded) {
